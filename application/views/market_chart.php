	  ...
	  //for($i=0; $i<count($rangArray); $i++){
		...
		<div class="item" data-dot="<button></button>">
					<div class="chart-body-wrap">
						<div class="chart-body">
							...
							$stock_tra=$ci->Market_model->chart_trader_data_search($_GET['start_date'],$_GET['end_date'],$st_data['symbol']);
							$stock_tra_two=$ci->Market_model->chart_trader_data_two_search($_GET['start_date'],$_GET['end_date'],$st_data['symbol']);
							?>
								<div class="item">
		...
		<div class="chart-line chart-line-right">
			<span style="width:<?php echo $down_per?>%; background:#205e20;" ><?php echo $st_data['down_cnt']; ?></span>
									...
									<div class="chart-line chart-line-left">
										<span style="width:<?php echo $down_per?>%; background:#e47f6d;" ><a class="trigger_popup_fricc" data-popup="popp<?php echo $b;?>"><?php echo $st_data['down_cnt']; ?></a></span>
									</div>
									<div class="chart-label"><?php echo $st_data['symbol']; ?><em>*</em></div>
									<div class="chart-line chart-line-right">
										<span style="width:<?php echo $up_per?>%; background:#205e20;" ><a class="trigger_popup_fricc" data-popup="pop<?php echo $a;?>"><?php echo $st_data['up_cnt']; ?></a></span>
									</div>
								</div>
...
<div class="hover_bkgr_fricc popp<?php echo $b;?>">
	...
	//ECHO '<PRE>';	
	//PRINT_R($stock_tra); 
	foreach ($stock_tra_two as $trd_dd) { 
	
	?>
    <tr>
       <td><a href="http://market.houjitech.com/index.php/Market/linestock?trader=<?php echo $trd_dd['trader_name']; ?>"><?php echo $trd_dd['trader_name']; ?></a></td>
      <td><?php echo $trd_dd['message_content']; ?></td>
      <td><?php echo $trd_dd['symbol']; ?></td>
      <td><?php echo $trd_dd['sector']; ?></td>
      <td><?php echo $trd_dd['success_percentage']; ?></td>
      <td><?php echo $trd_dd['failure_percentage']; ?></td>
      <td><?php echo $trd_dd['sector_success_percentage']; ?></td>
      <td><?php echo $trd_dd['sector_failure_percentage']; ?></td>
    </tr>
	<?php } ?>
...
$datess = date($formats, mktime(0,0,0,$m,($de-$i),$y)) ;  
		//echo $dates;
		$stock_data=$ci->Market_model->chart_stock_data($dates);
				...
				<div id="youtubeVideo" class="service-popup">
					...
					<div class="chart-body-wrap">
						<div class="chart-body">
							...
							$stock_tra=$ci->Market_model->chart_trader_data($dates,$st_data['symbol']);
							$stock_tra_two=$ci->Market_model->chart_trader_data_two($dates,$st_data['symbol']);
  ...
  <table>
	...
	<?php foreach ($stock_tra as $trd_d) { 
